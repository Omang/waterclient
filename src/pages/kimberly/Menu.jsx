...
const Menu = () => {
  ...
  return (
    <>
    <Link to={`/officer/kimberly`} className='border-b border-blue-500 hover:text-white hover:bg-blue-500 max-w-full p-2 mt-1 flex items-center justify-center'><h1>
            Home</h1></Link>
            <Link to={`/officer/kimapps`} className='border-b border-blue-500 hover:text-white hover:bg-blue-500 max-w-full p-2 mt-1 flex items-center justify-center'><h1>Applications</h1></Link>
